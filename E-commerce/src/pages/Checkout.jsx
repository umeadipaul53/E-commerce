      ...
      <section className="bg-white py-8 antialiased  md:py-16">
        <form action="#" className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <ol className="items-center flex w-full max-w-2xl text-center text-sm font-medium text-gray-500">
            <li className="after:border-1 flex items-center text-red-700 after:mx-6 after:hidden after:h-1 after:w-full after:border-b after:border-gray-200 sm:after:inline-block sm:after:content-[''] md:w-full xl:after:mx-10">
            ...
            <div className="min-w-0 flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative w-full">
                        <input
                          type="text"
                          id="phone-input"
                          className="z-20 block w-full rounded-e-lg border border-s-0 border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-red-500 focus:ring-red-500"
                  ...
                  <div className="sm:col-span-2">
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-red-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100"
                    >
                      <svg
                        className="h-5 w-5"
                        aria-hidden="true"
                    ...
                    <div className="flex items-start">
                      <div className="flex h-5 items-center">
                        <input
                          ...
                          name="payment-method"
                          value=""
                          className="h-4 w-4 border-gray-300 bg-white text-red-600 focus:ring-2 focus:ring-red-600 "
                          checked
                        />
                      </div>
              ...
              <div>
                ...
                <div className="flex max-w-md items-center gap-4">
                  ...
                  <button
                    type="button"
                    className="flex items-center justify-center rounded-lg bg-red-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300"
                  >
                    Apply
                  </button>
                </div>
