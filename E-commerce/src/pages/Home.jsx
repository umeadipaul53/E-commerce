        ...
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div className="mb-4 flex items-center justify-between gap-4 md:mb-8">
            ...
            <a
              href="#"
              title=""
              className="flex items-center text-base font-medium text-red-700 hover:underline"
            >
              See more categories
              <svg
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">Books</span>
            </a>
            <a
              href="#"
              className="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 "
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">Watches</span>
            </a>
            <a
              href="#"
              className="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 "
