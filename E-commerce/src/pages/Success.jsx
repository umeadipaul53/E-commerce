        ...
        <div className="mx-auto max-w-2xl px-4 2xl:px-0">
          ...
          <div className="space-y-4 sm:space-y-2 rounded-lg border border-gray-100 bg-gray-50 p-6 mb-6 md:mb-8">
            ...
            <dl className="sm:flex items-center justify-between gap-4">
              ...
              <dd className="font-medium text-gray-900">+(123) 456 7890</dd>
            </dl>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <a
              href="#"
              className="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-red-700 focus:z-10 focus:ring-4 focus:ring-gray-100 "
            >
              Return to shopping
            </a>
          </div>
